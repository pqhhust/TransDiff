...
def get_args_parser():
    ...
    ## Model
    parser.add_argument('--model', default='vit_cifar', type=str, choices = ['vit_cifar', 'diffusion', 'svdkl', 'diffusion_distillation', 'vit_cifar_distillation', 'temperature_scaling', 'mc_dropout', 'sdebnn'], help='Models name to use')
