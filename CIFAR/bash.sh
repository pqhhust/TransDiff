...
CUDA_VISIBLE_DEVICES=0,2 torchrun --nproc_per_node=2 main.py --model diffusion --seed 0 --depth 12 --attn-type softmax --num_heads 12 --hdim 768 --batch-size 2 --nb-epochs 100 --nb-run 1 --lr 3e-4 --weight-decay 5e-5 --warmup-epoch 0 --save-dir ./results/diffusion --backbone transformer --pretrained_dir /mnt/disk1/aiotlab/pqhung/TransDiff/qwen_cola_finetuned_merged --pretrained_seed 0 --trans_depth 1 --trans_num_heads 12 --trans_mlp_ratio 1 --trans_dropout 0.1 --lambda_mean 0.8 --lambda_var 0 --lambda_ce 0.2 --run_name DiT-5-seed ImageNet