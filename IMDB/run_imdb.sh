...
### SGPA
python3 main.py --depth 5 --attn-type sgpa --batch-size 32 --gpu 0 --nb-epochs 50 --nb-run 1 --model transformer_imdb --lr 1e-3 --seed 0 --save-dir ./results/vit_out_sgpa
...
### DiT match with SGPA  
python3 main.py --depth 5 --attn-type sgpa --batch-size 32 --gpu 0 --nb-epochs 20 --nb-run 1 --model diffusion --lr 5e-3 --seed 0 --save-dir ./results/diffusion --backbone transformer --pretrained_dir ./results/vit_out_sgpa --pretrained_seed 0 --trans_depth 1 --trans_num_heads 8 --trans_mlp_ratio 1 --trans_dropout 0.1 --lambda_mean 0.5 --lambda_var 0.2 --lambda_ce 0.3