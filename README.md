...
```
torchrun --nproc_per_node=8 main.py --model diffusion --seed 0 --depth 12 --attn-type softmax --num_heads 12 --hdim 768 --batch-size 64 --nb-epochs 50 --nb-run 1 --lr 1e-3 --weight-decay 5e-5 --warmup-epoch 5 --clip-grad-norm 1 --save-dir ./results/diffusion --backbone transformer --pretrained_dir ./results/vit_out --trans_depth 4 --trans_num_heads 12 --trans_mlp_ratio 4 --trans_dropout 0.1 --lambda_mean 1 --lambda_var 0 --lambda_ce 1 --run_name DiT-5-seed ImageNet
```
